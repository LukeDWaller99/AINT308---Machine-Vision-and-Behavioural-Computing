...
The program firstly reads in image pairs, taken from the left and right cameras, of a chequerboard  pattern target placed in different locations and orientations. This allows the program to create a list of intrinsic and extrinsic parameters. This allows for correction of these effects within the program. The chequerboard is of known size so the program can calibrate the cameras to a reference. This known as Bouquet stereo image calibration \cite{Bouget}.
